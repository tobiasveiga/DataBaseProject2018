...
CREATE TABLE PESSOA(
	...
	CONSTRAINT CK_CPF CHECK(CPF LIKE '[0-9]{3}\.[0-9]{3}\.[0-9]{3}\-[0-9]{2}'),
	CONSTRAINT CK_PESSOA_TELEFONE CHECK(TELEFONE LIKE '\([0-9]{2}\)[0-9]{8,9}')
);
...
CREATE TABLE EVENTO (
	...
	PRECO					REAL,
	PRECO_COMBINADO_LOCAL	REAL,
	
	CONSTRAINT PK_EVENTO PRIMARY KEY(ID),
    CONSTRAINT FK_EVENTO_LOCAL FOREIGN KEY (LOCAL) REFERENCES LOCAL
        ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT FK_EVENTO_CONTRATANTE FOREIGN KEY (CONTRATANTE) REFERENCES PESSOA
        ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE PARTICIPA(
	...
	CONSTRAINT FK_PARTICIPA_PESSOA FOREIGN KEY (PESSOA) REFERENCES PESSOA
        ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT FK_PARTICIPA_EVENTO FOREIGN KEY (EVENTO) REFERENCES EVENTO 
        ON DELETE CASCADE ON UPDATE CASCADE
);

CREATE TABLE TURMA(
	UNIVERSIDADE	VARCHAR(40),
	ANO				INTEGER,
	CURSO			VARCHAR(40),
    ...
    CONSTRAINT FK_TURMA_REPRESENTANTE FOREIGN KEY (REPRESENTANTE) REFERENCES PESSOA
        ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT FK_TURMA_FORMATURA FOREIGN KEY (FORMATURA) REFERENCES EVENTO
        ON DELETE RESTRICT ON UPDATE RESTRICT
);
...
CREATE TABLE EMPRESA_FUNCIONARIO(
    ...
    CONSTRAINT CK_EMPRESA_FUNCIONARIO_TELEFONE CHECK(TELEFONE LIKE '\([0-9]{2}\)[0-9]{8,9}')	
...
CREATE TABLE TRABALHA(
    ...
    CONSTRAINT FK_TRABALHA_PESSOA FOREIGN KEY (PESSOA) REFERENCES PESSOA
        ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT FK_TRABALHA_CARGO FOREIGN KEY (CARGO) REFERENCES CARGO
        ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT FK_TRABALHA_EMPRESA FOREIGN KEY (EMPRESA) REFERENCES EMPRESA_FUNCIONARIO
        ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT FK_TRABALHA_EVENTO FOREIGN KEY (EVENTO) REFERENCES EVENTO
        ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE INSUMO (
	...
	CONSTRAINT CK_INSUMO_RESTRICAO CHECK (UPPER(RESTRICAO) IN ('VEGETARIANA', 'VEGANA', 'CARNIVORA'))		
);
...
CREATE TABLE EMPRESA_INSUMO (
	...
	CONSTRAINT CK_EMPRESA_INSUMO_TELEFONE CHECK(TELEFONE LIKE '\([0-9]{2}\)[0-9]{8,9}')	
);
...
CREATE TABLE VENDA_INSUMO (
	...
	CONSTRAINT FK_VENDA_INSUMO_EMPRESA 
		FOREIGN KEY (EMPRESA) REFERENCES EMPRESA_INSUMO 
		ON DELETE CASCADE ON UPDATE CASCADE,
	CONSTRAINT FK_VENDA_INSUMO_INSUMO 
		FOREIGN KEY (INSUMO) REFERENCES INSUMO 
		ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE EMPRESA_BRINQUEDO (
	...
	CONSTRAINT CK_EMPRESA_BRINQUEDO_TELEFONE CHECK(TELEFONE LIKE '\([0-9]{2}\)[0-9]{8,9}')
);
...
CREATE TABLE VENDA_BRINQUEDO (
	...
	CONSTRAINT FK_VENDA_BRINQUEDO_EMPRESA 
		FOREIGN KEY (EMPRESA) REFERENCES EMPRESA_BRINQUEDO
		ON DELETE CASCADE ON UPDATE CASCADE,
	CONSTRAINT FK_VENDA_BRINQUEDO_BRINQUEDO 
		FOREIGN KEY (BRINQUEDO) REFERENCES BRINQUEDO
		ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE VENDA_BRINQUEDO_FORMATURA (
	...
	CONSTRAINT FK_VENDA_BRINQUEDO_FORMATURA_EMPRESA_BRINQUEDO 
		FOREIGN KEY (EMPRESA, BRINQUEDO) REFERENCES VENDA_BRINQUEDO
		ON DELETE RESTRICT ON UPDATE RESTRICT,
	CONSTRAINT FK_VENDA_BRINQUEDO_FORMATURA_FORMATURA  
        FOREIGN KEY (FORMATURA) REFERENCES EVENTO
        ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE EMPRESA_PRESENTE (
	...
	CONSTRAINT CK_EMPRESA_PRESENTE_TELEFONE CHECK (TELEFONE LIKE '\([0-9]{2}\) [0-9]{4}-[0-9]{4}')
);
...
CREATE TABLE VENDA_PRESENTE (
	...
	CONSTRAINT FK_VENDA_PRESENTE_EMPRESA 
		FOREIGN KEY (EMPRESA) REFERENCES EMPRESA_PRESENTE
		ON DELETE CASCADE ON UPDATE CASCADE,
	CONSTRAINT FK_VENDA_PRESENTE_PRESENTE 
		FOREIGN KEY (PRESENTE) REFERENCES PRESENTE
		ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE VENDA_PRESENTE_CASAMENTO (
	...
	CONSTRAINT FK_VENDA_PRESENTE_CASAMENTO_EMPRESA_PRESENTE 
		FOREIGN KEY (EMPRESA, PRESENTE) REFERENCES VENDA_PRESENTE
		ON DELETE RESTRICT ON UPDATE RESTRICT,
	CONSTRAINT FK_VENDA_PRESENTE_CASAMENTO_CASAMENTO  
        FOREIGN KEY (CASAMENTO) REFERENCES EVENTO
        ON DELETE CASCADE ON UPDATE CASCADE,
