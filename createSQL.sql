...
CREATE TABLE PESSOA(
	...
	CONSTRAINT CK_PESSOA_TELEFONE CHECK(TELEFONE SIMILAR TO '\([0-9]{2}\)[0-9]{8,9}')
);
...
CREATE TABLE EMPRESA_FUNCIONARIO(
    ...
    CONSTRAINT CK_EMPRESA_FUNCIONARIO_TELEFONE CHECK(TELEFONE SIMILAR TO '\([0-9]{2}\)[0-9]{8,9}')	
...
CREATE TABLE EMPRESA_INSUMO (
	...
	CONSTRAINT CK_EMPRESA_INSUMO_TELEFONE CHECK(TELEFONE SIMILAR TO '\([0-9]{2}\)[0-9]{8,9}')	
);
...
CREATE TABLE EMPRESA_BRINQUEDO (
	...
	CONSTRAINT CK_EMPRESA_BRINQUEDO_TELEFONE CHECK(TELEFONE SIMILAR TO '\([0-9]{2}\)[0-9]{8,9}')
);
...
CREATE TABLE EMPRESA_PRESENTE (
	...
	CONSTRAINT CK_EMPRESA_PRESENTE_TELEFONE CHECK (TELEFONE SIMILAR TO '\([0-9]{2}\)[0-9]{8,9}')
);
